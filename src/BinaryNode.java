...
public class BinaryNode<T>
{
     ...
     *
     * @return size of the left subtree
     */
    ...
    // ----------------------------------------------------------
    /**
     * Increase the left subtree's size by 1
     */
    public void incLeftSize()
    {
        ++this.leftSize;
    }
    ...
    // ----------------------------------------------------------
    /**
     * Decrease the left subtree's size by 1
     */
    public void decLeftSize()
    {
        --this.leftSize;
    }
}
